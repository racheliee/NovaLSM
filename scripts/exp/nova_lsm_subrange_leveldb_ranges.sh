...
client_bin_dir="/nova/NovaLSM-YCSB-Client"
results="/nova/results"
recordcount="$1"
exp_results_dir="/nova/results/nov-7-$recordcount"
dryrun="$2"
...
function run_bench() {
	...
	result_dir_name="nova-try-$try-d-$dist-w-$workload-of-$ordered_flush-ltc-$number_of_ltcs-stoc-$nstoc-l0-$l0_stop_write_mb-np-$num_memtable_partitions-mp-$major_compaction_max_parallism-c-$cardinality"
	...
	ltc_config_path="$config_dir/nova-shared-nrecords-10000000-nltc-1-nstoc-1-nranges-1-zipfian-0.00-read-1"
